...
public class ThreadedKernel extends Kernel {
	...
	KThread.selfTest();
	//ThreadTest.doJoinTest();
	//ThreadTest.doWaitUntilTest();
	//ThreadTest.doConditionTest();
	//ThreadTest.doCommunicatorTest();
	//ThreadTest.doPrioritySchedulerTest();
	//Boat.selfTest();
	//ThreadTest.doLotterySchedulerTest();
	Semaphore.selfTest();
	SynchList.selfTest();
